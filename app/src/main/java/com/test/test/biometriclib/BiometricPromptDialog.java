...
public class BiometricPromptDialog extends DialogFragment {
    ...
    public void setState(int state) {
        switch (state) {
            case STATE_NORMAL:
                mStateTv.setTextColor(mActivity.getResources().getColor(R.color.text_quaternary));
                mStateTv.setText(mActivity.getString(R.string.biometric_dialog_state_normal));
                mCancelBtn.setVisibility(View.VISIBLE);
                break;
            case STATE_FAILED:
                mStateTv.setTextColor(mActivity.getResources().getColor(R.color.text_red));
            ...
            case STATE_ERROR:
                ...
                break;
            case STATE_SUCCEED:
                mStateTv.setTextColor(mActivity.getResources().getColor(R.color.text_green));
